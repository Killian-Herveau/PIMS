...
ne=10; %nombre de point pris pour le calcul d'une valeur de l'histogramme
nv=90; %nombre de point d'abcisse de l'histogramme (impair=mieux)
...
if(candidatsg(3)==1) Pg=C;dir=[-1,-1];invm=1; end      %part en bas a gauche
if(candidatsg(4)==1) Pg=D;dir=[1,1]; end      %part en haut a droite
if(candidatsd(1)==1) Pd=A_;dir2=[1,1];invm=-1; end     %part en haut a droite
if(candidatsd(2)==1) Pd=B_;dir2=[1,-1]; end     %part en haut a gauche
if(candidatsd(3)==1) Pd=C;dir2=[-1,1];invm=1; end      %part en bas a droite
if(candidatsd(4)==1) Pd=D_;dir2=[-1,-1]; end     %part en bas a gauche
if(angle==0) Pg=[ic,1]; Pd=[ic,ximage]; dir2=[1,1];dir=[1,1]; end
