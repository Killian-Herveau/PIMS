...
% 2A 2C ou 2R ou 2e set\ Acquisition, Calibration ou Repetabilité
% E pour Exs interferogrammes
% num: valeur du focus
...
elseif(dossier(1)=='2')
    if(dossier(2)=='A')
        chemin=strcat('..\..\Projet 2A\2e set\Acquisition réelle\SOUSTR 0',snum,'.2Ddbl')
    elseif(dossier(2)=='C')
